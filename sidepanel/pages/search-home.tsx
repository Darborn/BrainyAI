...
export default function SearchHome() {
    const { searchSites, setSearchText, navigation } =
    ...
    return (
        <div className={"p-[14px] max-w-[600px] m-auto"}>
            <img
                className={"w-[64px] h-[64px] block mb-[34px] m-auto"}
                src={IconLogo}
                alt=""
            />
            <div
                className={
                    "text-[18px] font-bold w-full mb-[24px] text-center"
                }>
                AI Work Assistant
            </div>
            <div className={"bg-[#F3F4F9] p-[14px] rounded-[16px]"}>
                <textarea
                    ...
                    autoFocus
                    className={
                        "bg-[#F3F4F9] w-full h-[60px] outline-0 resize-none text-[15px]"
                    }
                    placeholder={"Enter your question..."}
                />
                <div
                    className={
                        "flex items-center justify-end text-[12px] cursor-pointer text-[#C2C2C2]"
                    }>
                    <div onClick={startSearch} className={"flex"}>
                        <img
                            className={"w-[15px] mr-[4px] mt-[3px]"}
                            src={IconEnter}
                            alt=""
                        />{" "}
                        Search
                ...
                {searchSites.map((item) => {
                    return (
                        <div
                            key={item.name}
                            className={
                                "rounded-[20px] shadow flex flex-col justify-between p-[20px]"
                            }>
                            <img
                                className={"w-[20px] block mb-[6px]"}
                                src={item.icon}
                                alt=""
                            />
