...
export const MESSAGE_ACTION_SHOULD_RELOAD_PERPLEXITY_IN_PANEL =
    "should_reload_perplexity_in_panel";
export const MESSAGE_ACTION_SHOULD_RELOAD_PHIND_IN_PANEL =
    "should_reload_phind_in_panel";
...
export const MESSAGE_ACTION_SET_QUOTING_SELECTION_TEXT =
    "set_quoting_selection_text";
export const MESSAGE_ACTION_SET_QUOTING_CANCEL =
    "set_quoting_selection_text_cancel";
export const MESSAGE_ACTION_SET_QUOTING_SELECTION_CLEAR_CURSOR =
    "set_quoting_selection_text_clear_cursor";
...
export const MESSAGE_PANEL_OPENED_PING_FROM_PANEL =
    "MESSAGE_PANEL_OPENED_PING_FROM_PANEL";
export const MESSAGE_ACTION_OPEN_PANEL_WITH_SEARCH_TEXT =
    "open_panel_with_search_text";
...
export const appendParamToUrl = function appendParamToUrl(
    url: string,
    paramKey: string,
    paramValue: any
) {
...
export const getLatestState = function <T>(
