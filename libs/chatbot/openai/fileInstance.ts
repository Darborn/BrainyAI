...
export class OpenAiFileSingleton implements BotFileInstance<OpenAiFileRef> {
    ...
    private async preUpload(
        ...
        try {
            const result =
                (await request.response?.json()) as PreUploadResponse;
            return [null, result];
        } catch (e) {
    ...
    private async getMetaDataRecursive(
        ...
        try {
            const result =
                (await request.response?.json()) as OpenAiFileMetadata;
    ...
    private async getMetadata(
        ...
        return await this.getMetaDataRecursive(
            fileId,
    ...
    private async ackUpload(
        ...
        try {
            const result =
                (await request.response?.json()) as AckUploadResponse;
