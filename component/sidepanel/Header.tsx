...
export default function () {
    ...
    return (
        <div
            className={
                "h-[52px] box-border flex-0 flex-shrink-0 flex-grow-0 w-full flex justify-between items-center px-[16px]"
            }>
            <Drawer
                placement={placement}
                width={64}
                ...
                footer={
                    <div
                        className={
                            "flex cursor-pointer justify-center items-center h-[100px]"
                        }
                        onClick={() => {
                            window.open(
            ...
            <div
                className={
                    "flex items-center font-[#333333] text-[20px] font-[600]"
                }>
                {titleText}
            </div>
            <div className="flex justify-end items-center">
                <Tooltip title="New Chat">
                    {titleText === HTitle.AIChatText && (
                        <img
                            className="w-[22px] mr-4 cursor-pointer"
                            src={NewChatIcon}
