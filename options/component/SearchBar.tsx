...
export const SearchBar = ({
    ...
    return (
        <div
            ...
            <div
                className={
                    "flex flex-row justify-start max-w-[500px] overflow-x-auto overflow-y-hidden hideScrollBar"
                }>
                <CTooltip
                    title="Search"
                    ...
                    .map((car) => {
                        ...
                        return (
                            <CTooltip
                                ...
                                <div
                                    className={
                                        "flex w-[28px] h-[28px] rounded-[4px] justify-center items-center bg-white hover:bg-[#F2F5FF] ml-[2px]"
                                    }
                                    onClick={() => {
                                        onItemClick(car.id);
                                    }}>
            ...
            <Popover
                ...
                <img
                    className={
                        "w-[16px] h-[16px] justify-start ms-[2px] cursor-pointer ml-[2px]"
                    }
                    src={TriangleIcon}
                    alt=""
                />
