...
export const Card = memo(function Card({
    ...
    return (
        <div
            ...
            className={"flex flex-col justify-start mt-[16px]"}>
            <div className={"h-[80px] w-full flex flex-row"}>
                <div
                    className={
                        "cursor-grab  h-full w-[7%] flex items-center justify-start"
                    }>
                    <img
                        src={IconDrag}
                ...
                <div
                    className={
                        "h-full w-[76%] max-w-[550px] flex flex-col justify-center"
                    }>
                    <div className={"flex items-center justify-start flex-row"}>
                        ...
                        <div
                            ...
                            className={
                                "text-[#333333] text-[15px] ms-[8px] flex justify-start items-center"
                            }>
                            {title}
                        </div>
                    </div>
                    <div
                        className={
                            "justify-start items-center text-[#5E5E5E] font-[400] text-[12px] mt-[4px] text-ellipsis whitespace-pre-wrap line-clamp-3 "
                        }>
                        {text}
                    </div>
                </div>
                <div
                    className={
                        "h-full w-[17%] flex items-center justify-start flex-row-reverse"
                    }>
                    <img
                        src={IconDelete}
                    ...
                    <img
                        src={IconEdit}
                        className={"h-[24px] w-[24px] mr-[16px] cursor-pointer"}
                        onClick={() => editCard(id)}
                        alt=""
                    />
                </div>
            ...
            <div
                className={
                    "h-[1px] bg-[#DADCE0] w-full px-[2px] justify-start mt-[16px]"
                }
            />
        </div>
    );
