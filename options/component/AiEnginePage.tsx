...
export default function AiEnginePage() {
    ...
    const promptTips =
        "Quick Action allows users to personalize prompts for selected text. The supported variables include:\n" +
    ...
    const promptTipsBr = (
        <div>
            Quick Action allows users to personalize prompts for selected text.
            The supported variables include:
            <br />- {PROMPT_PLACEHOLDER_TEXT}
            <br />- {PROMPT_PLACEHOLDER_LANG}
            <br />
            <br />
            Typically, you can manage the output language using{" "}
            {PROMPT_PLACEHOLDER_LANG} and convey your selected keywords to the
            prompt using {PROMPT_PLACEHOLDER_TEXT}. For instance,
            <br />
            Translate {PROMPT_PLACEHOLDER_TEXT} to {PROMPT_PLACEHOLDER_LANG}.
        </div>
    );
        ...
        if (card.itemType === PromptTypes.CUSTOM) {
            deletePrompt.confirm({
                ...
                icon: (
                    <img
                        src={IconDeleteRed}
                        className={"h-[24px] w-[24px] me-[4px]"}
                        alt=""
                    />
                ),
    ...
    function createCard() {
        Logger.log(
            `edit card=======${inputTitleValue}====${inputValue}====${language}=====${Date.now()}`
        );
        Logger.log(`showType=======${showType.current}`);
        Logger.log(
            `SelectedIcon=======${SelectedIcon} ======${SelectedIcon ? SelectedIcon.name : ""}`
        );
            ...
            if (inputTitleValue.trim() && inputValue.trim()) {
                void setCards([
                    ...cards,
                    {
                        ...
                        text: inputValue.includes(PROMPT_PLACEHOLDER_TEXT)
                            ? inputValue
                            : `${inputValue}${PROMPT_PLACEHOLDER_TEXT}`,
                        language: language,
                        isSelect: false
                    }
                ]);
                ...
                void messageApi.warning(
                    "Please complete filling in the relevant information."
                );
            }
    ...
    function editCard(id: string) {
        {
            ...
            Logger.log(
                `edit card=======${card.text}====${card.title}====${card.language}`
            );
    ...
    const outlinedIcons = Object.keys(Icons)
        .filter(
            (name) => name.endsWith("Outlined") && name !== "PlusSquareOutlined"
        )
        .map((iconName, index) => {
    ...
    const iconPopTitle = (
        <span
            className={
                "text-[20px] font-[600] justify-start mt-[35px] ps-[30px] text-[#333333]"
            }>
            Select Icon
        </span>
    );
    ...
    return (
        <div>
            <div
                className={
                    "bg-white shadow-[0_4px_12px_0px_rgba(0,0,0,.2)] overflow-hidden rounded-tl-[24px] rounded-tr-[24px] px-[56px] py-[32px] mt-[32px] flex flex-col"
                }>
                <div
                    className={
                        "text-[#333333] font-[700] text-[20px] justify-start"
                    }>
                    Shortcut Menu
                </div>
                <div
                    className={
                        "text-[#5E5E5E] font-[400] text-[12px] justify-start mt-[8px]"
                    }>
                    Customize your menu of actions by editing, rearranging
                    through dragging, and including custom actions below.
                </div>
                <div ref={drop}>
                    {cards.map((card) => (
                        <Card
                ...
                <div
                    ...
                    className={
                        "h-[40px] w-fit bg-[#0A4DFE] rounded-[8px] bg-opacity-10 inline-flex flex-row justify-start items-center mt-[32px] px-[16px] cursor-pointer"
                    }>
                    <img
                        src={IconPlus}
                    ...
                    <div
                        className={
                            "text-[#0A4DFE] font-[400] text-[15px] ml-[8px]"
                        }>
                        Create new shortcut
                    </div>
                </div>
            ...
            <Modal
                ...
                <div className={"flex flex-col items-start pl-[20px] w-full"}>
                    <div
                        className={
                            "flex flex-row justify-start items-center mt-[20px] h-[40px]"
                        }>
                        <div
                            className={
                                "font-[700] text-[20px] text-[#333333] w-[100px] flex justify-start items-center"
                            }>
                            icon
                        </div>
                        <Popover
                    ...
                    <div
                        className={
                            "flex flex-row justify-start items-center mt-[24px] h-[40px]"
                        }>
                        <div
                            className={
                                "font-[700] text-[20px] text-[#333333] w-[100px] flex justify-start items-center"
                        ...
                        <input
                            ...
                            className={
                                "h-[40px] rounded-[8px] border-[1px] border-[#D9D9D9] px-[16px] w-[520px]"
                            }
                    ...
                    <div
                        className={
                            "flex flex-row justify-start items-start mt-[24px] h-[199px]"
                        }>
                        <div
                            className={
                                "flex flex-row w-[100px] h-[40px] justify-start items-center"
                            }>
                            <div
                                className={
                                    "font-[700] text-[20px] text-[#333333] flex justify-start items-start"
                                }>
                                Prompt
                            </div>
                            <CTooltip
                                ...
                                <img
                                    src={QuestionIcon}
                                    className={
                                        "h-[16px] w-[16px] justify-start items-center ml-[4px]"
                                    }
                                />
                            </CTooltip>
                        </div>
                        <textarea
                            ...
                            readOnly={isReadOnly}
                            className={
                                "h-[199px] box-border rounded-[8px] border-[1px] border-[#D9D9D9] px-[16px] py-[16px] w-[520px] text-black leading-tight focus:outline-none focus:shadow-outline align-top overflow-auto whitespace-pre-wrap resize-none"
                            }
                    ...
                    <div
                        className={
                            "h-[1px] w-[620px] bg-[#DADCE0] justify-start mt-[24px]"
                        }
                    />
                    <div className={"h-[80px] w-[620px] flex flex-row"}>
                        <div
                            className={
                                "flex flex-col justify-center h-full flex-grow"
                            }>
                            <div
                                className={
                                    "text-[#333333] font-[700] text-[20px] justify-start"
                            ...
                            <div
                                className={
                                    "text-[#5E5E5E] font-[400] text-[13px] justify-start"
                                }>
                    ...
                    <div
                        className={
                            "h-[1px] w-[620px] bg-[#DADCE0] justify-start"
                        }
                    />
                    <div
                        className={
                            "w-[620px] justify-end flex flex-row mt-[40px]"
                        }>
                        <Button
                            onClick={() => createCard()}
                            type="primary"
                            className={"bg-[#0A4DFE] h-[40px] w-[161px]"}>
                            Submit
                        </Button>
                    </div>
                </div>
