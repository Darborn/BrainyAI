...
export const PdfPromptDatas = [
    ...
    },
    {
        ...
        isSelect: false,
        text:
            "Summarize 5 key points in this file by identifying 5 important points or takeaways. Ensure that the key points accurately capture the main ideas, concepts, and insights from the text in a succinct way. Avoid redundancy and focus on highlighting the most crucial and relevant information. Please use the following format:\n" +
            "Key Point 1:\n" +
            "Key Point 2:\n" +
            "Key Point 3:\n" +
            "Key Point 4:\n" +
    ...
    },
    {
        ...
        isSelect: false,
        text:
            "Based on this file, please generate 5 sets of quiz questions and answers. The questions should cover the key information and important concepts in the text. Ensure that the questions and answers are concise and easy to understand. Each question should have one correct answer.\n" +
